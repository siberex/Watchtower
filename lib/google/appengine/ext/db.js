...
mod = require("appengine/google/appengine/ext/db/utils");
for (var i in mod) exports[i] = mod[i];

var mod = require("appengine/google/appengine/ext/db/query");
for (var i in mod) exports[i] = mod[i];

mod = require("appengine/google/appengine/ext/db/properties");
for (var i in mod) exports[i] = mod[i];

mod = require("appengine/google/appengine/ext/db/errors");
for (var i in mod) exports[i] = mod[i];

mod = require("appengine/google/appengine/ext/db/model");
for (var i in mod) exports[i] = mod[i];

mod = require("appengine/google/appengine/api/datastore/types");
for (var i in mod) exports[i] = mod[i];
