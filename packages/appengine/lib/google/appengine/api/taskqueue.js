 ...
 *
 * Purging the queue takes about 20 seconds, regardless of the queue size.
 * Tasks continue executing during this time, until the backends recognize that the queue has been purged.
 * 
 * Args:
 *   queueName : Passed to the Queue constructor.
 */
exports.purge = function(queueName) {
